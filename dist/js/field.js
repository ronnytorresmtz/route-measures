...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-route-measures', __webpack_require__(3));
  Vue.component('detail-route-measures', __webpack_require__(6));
  Vue.component('form-route-measures', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        if (this.field.response['code'] != 200) {
            this.$toasted.show(this.field.response['message'], { type: 'error' });
        } else {
            this.field.value = this.field.distance['kms'] + ' Kilometers (' + this.field.distance['miles'] + ' Miles) <br> ' + this.field.duration['hours'] + ' Hours ' + this.field.duration['minutes'] + ' Minutes';
        }
    }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        if (this.field.response['code'] != 200) {
            ...
            this.field.value = this.field.distance['kms'] + ' Kilometers (' + this.field.distance['miles'] + ' Miles) <br><br> ' + this.field.duration['hours'] + ' Hours ' + this.field.duration['minutes'] + ' Minutes';
        }
    }
});
